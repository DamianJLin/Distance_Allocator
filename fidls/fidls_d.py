...
from fidls.utils import tau2map, map2tau, swap, swap_along_a_path
from fidls.utils import topgates_3_lev, gate_phy_distance, min_gate_dist
from fidls.utils import qubit_in_circuit, greedy_solved_gates, R_hat_3
import time
...
def good_next_mapping(tau, LD, C, Q, G, EG, V, SPL, QFilter_type, Fallback):    
    ...
    if any(tau[v] == -1 for v in V) or Fallback:  # i.e., tau incomplete
